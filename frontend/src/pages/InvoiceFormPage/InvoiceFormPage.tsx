...
const InvoiceFormPage: React.FC<InvoiceFormPageProps> = ({isReadOnly}) => {
    ...
    const [requiredFieldFilled, setRequiredFieldFilled] = useState<boolean>(true);
    const isEdit = !!id;
                ...
                <Row>
                    <Col>
                        <Form.Group className="mb-3">
                            ...
                            />
                            {!requiredFieldFilled && (
                                <Form.Label><span style={redText}>Polje je obvezno!</span></Form.Label>)}
                        </Form.Group>
                    </Col>
                    <Col>
                        <Form.Group className="mb-3">
